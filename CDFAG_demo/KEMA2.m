...
% 2) Compute RBF kernels
        ...
        K1 = kernelmatrix('lin',[X1,U1],[X1,U1],sigma1);
        sigma2 =  15*mean(pdist([X2]'));
        K2 = kernelmatrix('lin',[X2,U2],[X2,U2],sigma2);
        K = blkdiag(K1,K2);
        KT1 = kernelmatrix('lin',[X1,U1],XT1,sigma1);
        KT2 = kernelmatrix('lin',[X2,U2],XT2,sigma2);
...
subplot(1,2,2)
 ...
 axis image
  figure;
 subplot(1,2,1)
 scatter3(Phi1TtoF(1,:),Phi1TtoF(2,:),Phi1TtoF(3,:),20,YT1,'f'), hold on, scatter3(Phi2TtoF(1,:),Phi2TtoF(2,:),Phi2TtoF(3,:),20,YT2),colormap(jet)
 title('Projected data (RBF)'),grid on
  axis image
%   axis([-2.5 2.5 -2.5 2.5])
 subplot(1,2,2)
 plot3(Phi1TtoF(1,:),Phi1TtoF(2,:),Phi1TtoF(3,:),'r.'), hold on, plot3(Phi2TtoF(1,:),Phi2TtoF(2,:),Phi2TtoF(3,:),'.'),colormap(jet)
