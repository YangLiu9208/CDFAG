function [tr_idx, ts_idx, tr_idx2,ts_idx2]=train_test_split2(set_tr_num,set_tr_num2,source_label,target_label)
    ...
    ts_idx2 = [];
     for jj = 1:nclass
            ...
            ts_idx = [ts_idx; idx_label(idx_rand(tr_num+26:end))];
            tr_idx2 = [tr_idx2; idx_label2(idx_rand2(1:tr_num2))];
            ts_idx2 = [ts_idx2; idx_label2(idx_rand2(tr_num2+26:end))];
      end
end