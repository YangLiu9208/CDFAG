function [tr_idx, ts_idx, tr_idx2,ts_idx2]=train_test_split(set_tr_num,set_tr_num2,source_label,target_label)
    ...
    ts_idx2 = [];
     for jj = 1:nclass
            ...
            ts_idx2 = [ts_idx2; idx_label2(idx_rand2(tr_num2+1:end))];
      end
end